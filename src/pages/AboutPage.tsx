        ...
        <div className="pt-32 pb-20">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="text-4xl md:text-5xl mb-6 lato-bold from-blue-700 via-cyan-500 to-indigo-700 ">About EnProSys</h1>
                <div className="max-w-3xl space-y-6 text-lg text-muted-foreground second">
                  <p>
              ...
              >
                <div className="relative w-full h-full min-h-96">
                  ...
                  <div className="absolute inset-0  from-[#E0ECFF] via-[#D8F7FF] to-[#E6E8FF] rounded-3xl blur-3xl" />

                  {/* Main glassy card */}
                  <div className="relative from-[#E0ECFF] via-[#D8F7FF] to-[#E6E8FF] backdrop-blur-2xl border border-white/20 rounded-3xl p-8 shadow-2xl h-full flex flex-col justify-center items-center overflow-hidden group">
                    {/* Animated gradient background */}
                    <div className="absolute inset-0 bg-linear-to-br from-[#E0ECFF] via-[#D8F7FF] to-[#E6E8FF] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    ...
                    <div className="relative z-10 space-y-8 text-center">
                      ...
                      <div className="grid grid-cols-2 gap-6 justify-items-center mb-4">
                        <motion.div
                          ...
                          className="p-4 from-[#E0ECFF] via-[#D8F7FF] to-[#E6E8FF] backdrop-blur-md rounded-2xl border border-white/20 hover:border-[#0082BE]/50 transition-all"
                        >
                          <Database className="w-10 h-10 text-[#0EA5E9]" />
                        </motion.div>

                        <motion.div
                          whileHover={{ scale: 1.1, rotate: -5 }}
                          className="p-4 from-[#E0ECFF] via-[#D8F7FF] to-[#E6E8FF]  backdrop-blur-md rounded-2xl border border-white/20 hover:border-[#0A6EAA]/50 transition-all"
                        >
                          <Cpu className="w-10 h-10 text-[#1D4ED8]" />
                        </motion.div>
                        ...
                        >
                          <Code className="w-10 h-10 text-[#4F46E5]" />
                        </motion.div>
                      ...
                      <div className="space-y-2 py-4">
                        ...
                        <p className="text-2xl font-semibold bg-linear-to-r from-[#1D4ED8] to-[#4F46E5] bg-clip-text text-transparent">
                          Infotech
                        </p>
                      </div>
